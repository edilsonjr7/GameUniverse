...
        // Inclui o objeto TipoUser inteiro para acessar 'developer' (embora seja false)
...
            adm: clienteTipo.adm,
            developer: clienteTipo.developer // ✅ Adicionado para consistência
        };
        
...
        }
        
        // Aqui o payload do JWT JÁ estava correto.
        const payload = {
...
                email: usuario.email,
                adm: usuario.tipoUser.adm,
                developer: usuario.tipoUser.developer  // CORREÇÃO CRÍTICA: Adicionado aqui!
            }
        });
